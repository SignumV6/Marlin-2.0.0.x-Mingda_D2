...
public:
  ...
  static void init_lcd();
    ...
    static void set_t_status(const char* const tramming_message, const bool persist=false);
    static void set_t_status_P(PGM_P const tramming_message, const int8_t level=0);
    ...
    static inline void set_t_status(const char* const, const bool=false) {}
    static inline void set_status_P(PGM_P const, const int8_t=0) {}
    static inline void set_t_status_P(PGM_P const, const int8_t=0) {}
