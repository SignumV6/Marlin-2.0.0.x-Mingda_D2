...
namespace Language_de {
  ...
  PROGMEM Language_Str MSG_TRAMMING_FB1                    = _UxGT("Drehe %s:\n%s um %.2f Umdrehungen und ");
  PROGMEM Language_Str MSG_TRAMMING_FB2                    = _UxGT("%d Minuten\n  (%.2f mm)%s\n ");
  ...
  //                                       ...oder 2 Zeilen auf einem 3-Zeilen-Display.
    ...
    PROGMEM Language_Str MSG_NOZZLE_PARKED                 = _UxGT(MSG_3_LINE("Kopf geparkt"));
  #else // LCD_HEIGHT < 4
    ...
    PROGMEM Language_Str MSG_NOZZLE_PARKED                 = _UxGT(MSG_1_LINE("Kopf geparkt"));
