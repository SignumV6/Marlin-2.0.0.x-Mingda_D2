...
// icon                       label
   ...
   {{ICON_MOVE,                 LABEL_MOVE},
    ...
    #endif
      {ICON_HEAT,                 LABEL_PREHEAT}, // GST
    // {ICON_BACKGROUND,           LABEL_BACKGROUND}, // GST
    {ICON_BACK,                 LABEL_BACK}}
    #endif
  #endif
};
...
void menuCallBackMainPage() {
  ...
  switch(key_num)
  {
      ...
      case KEY_ICON_4: infoMenu.menu[++infoMenu.cur] = menuSettings;  break;
        #if ENABLED(AUTO_BED_LEVELING_BILINEAR) || ENABLED(AUTO_BED_LEVELING_UBL)
          case KEY_ICON_5: infoMenu.menu[++infoMenu.cur] = menuAutoLeveling;   break;
        #endif
      case KEY_ICON_6: infoMenu.menu[++infoMenu.cur] = menuPreheat;   break; // GST
      case KEY_ICON_7: infoMenu.cur--;  break;
      default:break;
    #endif
    #endif
