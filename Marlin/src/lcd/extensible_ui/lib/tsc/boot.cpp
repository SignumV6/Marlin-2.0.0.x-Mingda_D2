...
"Mmm_01", "Mmm_1", "Mmm_10", "Mmm_100", "Dec_X", "Dec_Y","Dec_Z", "Home_X", "Home_Y", "Home_Z", "Folder",
"File", "Page_up", "Page_d~1", "Pause", "Resume", "Load", "Unload", "Slow", "Normal", "Fast",  
"Emm_1", "Emm_5", "Emm_10", "Emm_100", "S_1", "S_5", "S_10", "Full", "Half", "Rotate", "Language", "TP_Adj~1", "More", "About",
"BackGroundColor", "FontColor", "Disconnect", "BaudRate", "Percen~1", "BabyStep", "Mmm_001", "OnBoardSD", "OnTFTSD", "U_Disk",
"Runout", "Point_1", "Point_2", "Point_3", "Point_4", "Gcode", "BLTouch", "BLTouc~1",
"BLTouc~2", "BLTouc~3", "BLTouc~4", "TSCSet~1", "Machin~1", "Featur~1", "ProbeO~1", "EEPROM~1", "SilentOn", "ShutDown",
"RGB_Se~1", "RGB_Red", "RGB_Gr~1", "RGB_Blue", "RGB_Wh~1", "RGB_Off", "Prehea~1", "Prehea~4", "Prehea~3", "Prehea~2",
"PowerS~1", "abl", "mbl", "Home_Move", "Heat_Fan", "ManualLevel", "CoolDown", "Silent~1","Status~3","Status~1","Status~2","MainMenu",
"Status~4","StatusFlow","InfoBox_part1", "InfoBox_part2", "EM_Stop",*/
"Heat",
"Move",
"Home", 
"Print", 
